...
function displayItems() {
    ...
    var drinksDiv = document.getElementById('drinks');
    ...
    pizzaData.map(item => {
        ...
        itemPrice.innerText = 'Price : Ksh ' + item.price;
    ...
    breakfastData.map(item => {
        ...
        itemCard.appendChild(itemName);
        itemCard.appendChild(itemPrice);
        breakfastDiv.appendChild(itemCard);
    ...
    dishesData.map(item => {
        ...
        itemCard.appendChild(itemName);
        itemCard.appendChild(itemPrice);
        dishesDiv.appendChild(itemCard);
    ...
    drinksData.map(item => {
        ...
        itemCard.appendChild(itemName);
        itemCard.appendChild(itemPrice);
        drinksDiv.appendChild(itemCard);
...
function categoryList(){
    var categoryListDiv= document.getElementById('category-list');
     ...
     categorylistData.map(item=> {
        ...
        categoryListDiv.appendChild(listCard); 
...
function decrementItem(){
    ...
    if(decObj.quantity > 1){
        ...
        document.getElementById(decObj.id).classList.remove
        ('toggle-heart');
        ...
        if(cartData.length < 1 && flag){
            document.getElementById('food-items').classList.toggle
            ('food-items');
            document.getElementById('category-list').classList.toggle
            ('food-items');
            document.getElementById('m-cart-plus').classList. toggle('m-cart-toggle');
            document.getElementById('cart-page').classList.toggle
            ('cart-toggle');
           document.getElementById('category-header').classList.toggle   ('toggle-category');
           document.getElementById('checkout').classList.toggle
            ('cart-toggle');
            flag= false;
...
function totalAmount(){
   ...
   document.getElementById('total-price').innerText= 'Total Price: Ksh ' + sum;
   document.getElementById('m-total-amount').innerText= 'Total Price: Ksh ' + sum;
}
...
function addAddress(){
    ...
    if(address){
       ...
       document.getElementById('m-add-address').innerText = ' ' +  address;
        ...
        document.getElementById('add-address').innerText = ' Your Addres ';
...
window.onresize= window.onload= function(){
    ...
    console.log(size);
    if(size <800){
        var cloneFoodItems= document.getElementById('food-items').
        cloneNode(true);
        var cloneCartpage= document.getElementById('cart-page').
        cloneNode(true);
        document.getElementById('food-items').remove();
        document.getElementById('cart-page').remove();
        document.getElementById('category-header').after
        (cloneFoodItems);
